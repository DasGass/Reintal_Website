# 📸 Images Folder - Reintal GM Website

This folder contains all images used on the Reintal GM website.
...
**File to add:** `reintal-logo.png` or `reintal-logo.svg`
...
**How to add:**
1. Save your logo file as `reintal-logo.png` (or `.svg`)
2. Place it in `C:\Users\elchi\.gemini\antigravity\Reintal_Website\public\images\logo\`
...
<span class="logo-text">Reintal GM</span>

<!-- Replace with: -->
<img src="images/logo/reintal-logo.png" alt="Reintal GM Logo" style="height: 40px;">
```
...
1. **Add your logo:**
   - Save as `reintal-logo.png`
   - Place in `public/images/logo/`
   - File path: `C:\Users\elchi\.gemini\antigravity\Reintal_Website\public\images\logo\reintal-logo.png`

2. **Add your hero image:**
   - Save as `hero-main.jpg`
   - Place in `public/images/hero/`
   - File path: `C:\Users\elchi\.gemini\antigravity\Reintal_Website\public\images\hero\hero-main.jpg`
